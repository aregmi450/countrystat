    ...
    entryDetails: [
      {
        title: "Admission Letter From University",
        description:
          "You can get the application letter from the university after applying via their application portal. They charge certain amount for the application but can be exemepted on request from certain universities.",
      },
      {
        title: "Valid Student Visa and Course Enrollement",
        description:
